...
여기서 문제는 put 2번은 어차피 덮어 쓰고, API 호출은 2번 되서 낭비. <br>
진짜 문제는 DB 저장은 버그입니다.
...
솔직히 말하면 채울게 없습니다.<br>
에러 나면 저장을 안하면 되거든요.<br>
그런데, 안채우는거보다 채우는게 낫습니다.<br>
왜냐하면 현재의 저는 매우 확신에 차있지만, 미래의 저는 바보기 때문에, 저는 미래의 저에게 친절해야할 필요가 있습니다. <br>
...
아무리 Voyage가 싸다고 하지만, 초절정인기웹사이트가 되버리면 그 API 비용도 아깝잖아요. 그것도 한번 절약을 해 봅시다.