...
대신 **무조건 이렇게 나와야 하는 것들**만 확인하기로 했어요.<br>
2차원이면 저도 답을 아니까요.
...
200ms면 빠르네? 하실 수 도 있는데, 지금 요청을 고작 300건을 DB에 넣는데 1분 내외로 소요됩니다. 엄청 느리죠? 그러니 다음 시간에는 batch이용해서, 모아서 요청하는 법을 알아 봅시다.