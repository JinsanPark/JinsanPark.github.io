...
[지난 시간에](/posts/Embedding-Project-7/) 캐시 히트 테스트를 짜봤습니다.<br>
...
[다음 시간에](/posts/Embedding-Project-9/) LRU라는걸 직접 만들어 볼까 하는데, 스프링에 붙이기 전에 순수 자바 클래스로 먼저 만들고 테스트부터 짜보려고 합니다.
